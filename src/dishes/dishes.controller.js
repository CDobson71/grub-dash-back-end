...
//Note: honestly I would probably make this a utils and have a second parameter for what the things is so that I can make it either say dish or order with a single function, not sure if that is good style
